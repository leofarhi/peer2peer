...
export const TRANSLATIONS = {
  en: {
    ...
    legal_editor_desc: "The Peer2Peer application is a student project developed as part of the 42 school curriculum.",
    legal_developer: "Developer:",
    legal_contact_label: "Contact:",
    legal_contact_value: "via the app's contact form.",
    legal_status_label: "Status:",
    legal_status_value: "Non-profit educational project.",
    legal_host_title: "2. Hosting",
    legal_host_desc: "The application is hosted by:",
    legal_host_name: "Railway Corp.",
    legal_host_address: "301 Howard Street, Suite 600, San Francisco, CA 94105, USA",
    legal_ip_title: "3. Intellectual Property",
    legal_ip_desc: "The source code belongs to its author. The 42 school logo and visual identity belong to the 42 association.",
    ...
    privacy_s1_desc: "As part of Peer2Peer, we process the following data:",
    privacy_s1_b1_title: "42 Data (via API):",
    privacy_s1_b1_desc: " Login, Email, Profile picture, Campus.",
    privacy_s1_b2_title: "Declarative Data:",
    privacy_s1_b2_desc: " Bio, Gender, Preferences, Custom photos, Birth date.",
    privacy_s1_b3_title: "Usage Data:",
    privacy_s1_b3_desc: " Connection logs, Matches, Messages.",
    privacy_s2_title: "2. Purpose",
    privacy_s2_desc: "This data is used solely to:",
    privacy_s2_b1: "Allow secure login via 42 Intra.",
    privacy_s2_b2: "Suggest relevant profiles (Matching).",
    privacy_s2_b3: "Ensure platform security and moderation.",
    privacy_s2_highlight: "No data is sold to third parties.",
    privacy_s3_title: "3. Visibility",
    privacy_s3_desc: "Your profile (Photo, Name, Age, Bio) is visible only to other students logged into the app. Private messages are accessible only to you and your match (unless reported for moderation).",
    privacy_s4_title: "4. Your Rights (GDPR)",
    privacy_s4_desc: "In accordance with GDPR, you have the right to access, rectify, and delete your data. You can delete your account and all associated data by contacting the administrator via the contact form.",
  ...
  fr: {
    ...
    legal_editor_desc: "L'application Peer2Peer est un projet étudiant développé dans le cadre du cursus de l'école 42.",
    legal_developer: "Développeur :",
    legal_contact_label: "Contact :",
    legal_contact_value: "via le formulaire de contact de l'application.",
    legal_status_label: "Statut :",
    legal_status_value: "Projet pédagogique à but non lucratif.",
    legal_host_title: "2. Hébergement",
    legal_host_desc: "L'application est hébergée par :",
    legal_host_name: "Railway Corp.",
    legal_host_address: "301 Howard Street, Suite 600, San Francisco, CA 94105, États-Unis",
    legal_ip_title: "3. Propriété Intellectuelle",
    legal_ip_desc: "Le code source de l'application est la propriété de son auteur. Le logo et l'identité visuelle de l'école 42 appartiennent à l'association 42.",
    ...
    privacy_s1_desc: "Dans le cadre de l'utilisation de Peer2Peer, nous traitons les données suivantes :",
    privacy_s1_b1_title: "Données 42 (via API) :",
    privacy_s1_b1_desc: " Login, Email, Photo de profil, Campus.",
    privacy_s1_b2_title: "Données déclaratives :",
    privacy_s1_b2_desc: " Bio, Genre, Préférences de rencontre, Photos additionnelles, Date de naissance.",
    privacy_s1_b3_title: "Données d'utilisation :",
    privacy_s1_b3_desc: " Logs de connexion, Matchs, Messages échangés.",
    privacy_s2_title: "2. Finalité du traitement",
    privacy_s2_desc: "Ces données sont utilisées uniquement pour :",
    privacy_s2_b1: "Permettre la connexion sécurisée via l'Intra 42.",
    privacy_s2_b2: "Vous proposer des profils pertinents (Matching).",
    privacy_s2_b3: "Assurer la sécurité et la modération de la plateforme.",
    privacy_s2_highlight: "Aucune donnée n'est revendue à des tiers.",
    privacy_s3_title: "3. Visibilité",
    privacy_s3_desc: "Votre profil (Photo, Prénom, Âge, Bio) est visible uniquement par les autres étudiants connectés sur l'application. Vos messages privés ne sont accessibles qu'à vous et votre interlocuteur (sauf signalement nécessitant une modération).",
    privacy_s4_title: "4. Vos Droits (RGPD)",
    privacy_s4_desc: "Conformément au RGPD, vous disposez d'un droit d'accès, de rectification et de suppression de vos données. Vous pouvez supprimer votre compte et toutes les données associées en contactant l'administrateur via le formulaire de contact.",
